...
public class Marc extends IA{
     ...
     */
    public Marc(Game game, List<Card> gameCards, List<Card> gamerCards, Screen screen) {
        super(game, "Marc", gameCards, gamerCards, screen);
    }
