...
public class Diane extends IA{
     ...
     */
    public Diane(Game game, List<Card> gameCards, List<Card> gamerCards, Screen screen) {
        super(game, "Diane", gameCards, gamerCards, screen);
    }
